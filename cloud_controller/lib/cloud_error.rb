...
class CloudError < StandardError
  ...
  SDS_ERROR = [506, HTTP_INTERNAL_SERVER_ERROR, "Get error from serialization_data_server: '%s'"]
  SDS_NOT_FOUND = [507, HTTP_NOT_FOUND, "No available active serialization data server"]
