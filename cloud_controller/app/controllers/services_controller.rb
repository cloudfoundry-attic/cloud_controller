...
class ServicesController < ApplicationController
  ...
  def import_from_data
    ...
    upload_url = target_sds = active_sds.sample if active_sds && active_sds.count > 0
    ...
    req = {:upload_url => upload_url, :upload_token => upload_token, :data_file_path => data_file.path, :upload_timeout => upload_timeout}
